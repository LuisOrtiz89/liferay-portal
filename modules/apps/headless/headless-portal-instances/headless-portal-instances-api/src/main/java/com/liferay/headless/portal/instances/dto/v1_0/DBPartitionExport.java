...
@Generated("")
@GraphQLName(
	description = "An export of a portal instance to a database partition schema.",
	value = "DBPartitionExport"
)
...
@XmlRootElement(name = "DBPartitionExport")
public class DBPartitionExport implements Serializable {

	public static DBPartitionExport toDTO(String json) {
		return ObjectMapperUtil.readValue(DBPartitionExport.class, json);
	}

	public static DBPartitionExport unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DBPartitionExport.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The name of the schema created by the export, lexported_ followed by the company ID."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.portal.instances.dto.v1_0.DBPartitionExport",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1962228220