...
public abstract class BaseContentSetResourceTestCase {
	...
	protected void assertValid(ContentSet contentSet) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("collectionType", additionalAssertFieldName)) {
			...
			if (Objects.equals("classNameId", additionalAssertFieldName)) {
				if (!(contentSet instanceof AssetListCollection)) {
					continue;
				}

				if (((AssetListCollection)contentSet).getClassNameId() ==
						null) {
			...
			if (Objects.equals("classPK", additionalAssertFieldName)) {
				...
				if (((AssetListCollection)contentSet).getClassPK() == null) {
					valid = false;
				}
			...
			if (Objects.equals(
				...
				if (((AssetListCollection)contentSet).
			...
			if (Objects.equals("key", additionalAssertFieldName)) {
				if (!(contentSet instanceof CollectionProvider)) {
					continue;
				}

				if (((CollectionProvider)contentSet).getKey() == null) {
					valid = false;
				}
			...
			if (Objects.equals("key", additionalAssertFieldName)) {
				if (!(contentSet instanceof RelatedCollectionProvider)) {
					continue;
				}

				if (((RelatedCollectionProvider)contentSet).getKey() == null) {
					valid = false;
				}
			...
			if (Objects.equals("sourceItemType", additionalAssertFieldName)) {
				if (!(contentSet instanceof RelatedCollectionProvider)) {
					continue;
				}

				if (((RelatedCollectionProvider)contentSet).
						getSourceItemType() == null) {
			...
			if (Objects.equals("fieldName", additionalAssertFieldName)) {
				if (!(contentSet instanceof
						RepeatableFieldsCollectionProvider)) {

					continue;
				}

				if (((RepeatableFieldsCollectionProvider)contentSet).
						getFieldName() == null) {
			...
			if (Objects.equals("key", additionalAssertFieldName)) {
				...
				if (((RepeatableFieldsCollectionProvider)contentSet).getKey() ==
						null) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("collectionType", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						contentSet1.getCollectionType(),
						contentSet2.getCollectionType())) {
			...
			if (Objects.equals("classNameId", additionalAssertFieldName)) {
				if (!(contentSet1 instanceof AssetListCollection) ||
					!(contentSet2 instanceof AssetListCollection)) {

					continue;
				}

				if (!Objects.deepEquals(
						((AssetListCollection)contentSet1).getClassNameId(),
						((AssetListCollection)contentSet2).getClassNameId())) {
			...
			if (Objects.equals("classPK", additionalAssertFieldName)) {
				...
				if (!Objects.deepEquals(
						((AssetListCollection)contentSet1).getClassPK(),
						((AssetListCollection)contentSet2).getClassPK())) {
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						((AssetListCollection)contentSet1).
							getExternalReferenceCode(),
						((AssetListCollection)contentSet2).
							getExternalReferenceCode())) {
			...
			if (Objects.equals("key", additionalAssertFieldName)) {
				if (!(contentSet1 instanceof CollectionProvider) ||
					!(contentSet2 instanceof CollectionProvider)) {

					continue;
				}

				if (!Objects.deepEquals(
						((CollectionProvider)contentSet1).getKey(),
						((CollectionProvider)contentSet2).getKey())) {
			...
			if (Objects.equals("key", additionalAssertFieldName)) {
				if (!(contentSet1 instanceof RelatedCollectionProvider) ||
					!(contentSet2 instanceof RelatedCollectionProvider)) {

					continue;
				}

				if (!Objects.deepEquals(
						((RelatedCollectionProvider)contentSet1).getKey(),
						((RelatedCollectionProvider)contentSet2).getKey())) {
			...
			if (Objects.equals("sourceItemType", additionalAssertFieldName)) {
				...
				if (!Objects.deepEquals(
						((RelatedCollectionProvider)contentSet1).
							getSourceItemType(),
						((RelatedCollectionProvider)contentSet2).
							getSourceItemType())) {
			...
			if (Objects.equals("fieldName", additionalAssertFieldName)) {
				if (!(contentSet1 instanceof
						RepeatableFieldsCollectionProvider) ||
					!(contentSet2 instanceof
						RepeatableFieldsCollectionProvider)) {
				...
				if (!Objects.deepEquals(
						((RepeatableFieldsCollectionProvider)contentSet1).
							getFieldName(),
						((RepeatableFieldsCollectionProvider)contentSet2).
							getFieldName())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("collectionType")) {
			throw new IllegalArgumentException(
	...
	protected ContentSet randomContentSet() throws Exception {
		List<Supplier<ContentSet>> suppliers = Arrays.asList(
			() -> {
				AssetListCollection contentSet = new AssetListCollection();

				contentSet.setItemSubtype(
					StringUtil.toLowerCase(RandomTestUtil.randomString()));
				contentSet.setItemType(
					StringUtil.toLowerCase(RandomTestUtil.randomString()));
				contentSet.setTitle(
					StringUtil.toLowerCase(RandomTestUtil.randomString()));

				contentSet.setClassNameId(RandomTestUtil.randomLong());
				contentSet.setClassPK(RandomTestUtil.randomLong());
				contentSet.setExternalReferenceCode(
					StringUtil.toLowerCase(RandomTestUtil.randomString()));

				contentSet.setCollectionType(
					ContentSet.CollectionType.create("AssetListCollection"));

				return contentSet;
			},
			() -> {
				CollectionProvider contentSet = new CollectionProvider();
				...
				contentSet.setCollectionType(
					ContentSet.CollectionType.create("CollectionProvider"));
			...
			() -> {
				...
				contentSet.setKey(
					StringUtil.toLowerCase(RandomTestUtil.randomString()));
				contentSet.setSourceItemType(
					StringUtil.toLowerCase(RandomTestUtil.randomString()));

				contentSet.setCollectionType(
					ContentSet.CollectionType.create(
						"RelatedCollectionProvider"));
		...
		Supplier<ContentSet> supplier = suppliers.get(
...
// LIFERAY-REST-BUILDER-HASH:-192587079