...
@Generated("")
@GraphQLName(
	description = "A content set backed by a related collection provider.",
	value = "RelatedCollectionProvider"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A content set backed by a related collection provider."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "RelatedCollectionProvider")
public class RelatedCollectionProvider
	extends ContentSet implements Serializable {

	public static RelatedCollectionProvider toDTO(String json) {
		return ObjectMapperUtil.readValue(
			RelatedCollectionProvider.class, json);
	}

	public static RelatedCollectionProvider unsafeToDTO(String json) {
	...
	public String getSourceItemType() {
		if (_sourceItemTypeSupplier != null) {
			sourceItemType = _sourceItemTypeSupplier.get();

			_sourceItemTypeSupplier = null;
		}
	...
	public void setSourceItemType(
		...
		_sourceItemTypeSupplier = () -> {
			try {
				return sourceItemTypeUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _sourceItemTypeSupplier;
	...
	public String toString() {
		...
		String sourceItemType = getSourceItemType();
		...
		if (sourceItemType != null) {
			...
			sb.append(_escape(sourceItemType));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.RelatedCollectionProvider",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1665156751