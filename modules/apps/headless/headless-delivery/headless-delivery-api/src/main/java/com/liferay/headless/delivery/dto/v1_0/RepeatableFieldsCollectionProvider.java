...
@Generated("")
@GraphQLName(
	description = "A content set backed by a repeatable field collection provider.",
	value = "RepeatableFieldsCollectionProvider"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A content set backed by a repeatable field collection provider."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "RepeatableFieldsCollectionProvider")
public class RepeatableFieldsCollectionProvider
	...
	public static RepeatableFieldsCollectionProvider toDTO(String json) {
		return ObjectMapperUtil.readValue(
			RepeatableFieldsCollectionProvider.class, json);
	}

	public static RepeatableFieldsCollectionProvider unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.RepeatableFieldsCollectionProvider",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1356210376