	...
	public void testCleanUpTableDoesNotAffectControlTablesWithDatabasePartitionEnabled()
		...
		try (SafeCloseable safeCloseable =
			...
			_testCleanUpTable(
				...
				() -> _db.runSQL(
					"delete from VirtualHost where companyId = " + companyId),
				() -> _db.runSQL(
					StringBundler.concat(
						"insert into VirtualHost (mvccVersion, ",
						"ctCollectionId, virtualHostId, companyId, ",
						"layoutSetId, hostname) values (0, 0, ",
						RandomTestUtil.nextLong(), ", ", companyId, ", 0, '",
